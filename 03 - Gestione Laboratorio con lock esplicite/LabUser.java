...
public class LabUser implements Runnable {
	...
	// Per gli studenti è impostato dal tutor, per i tesisti dall'utente. Per i professori non è significativo.
	private int IndPC = -1;
	...
	public LabUser(int NumPC, UserType tipo, int ID, LabTutor Tutor, int MaxAccessi, int MaxAttesa, int MaxUtilizzo, char[] ThreadStatus, int IndStatus)
	{
